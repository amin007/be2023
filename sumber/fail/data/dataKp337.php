...
if ( ! function_exists('belanjaKp337V01')):
	function belanjaKp337V01()
	{
		// belanja | hasil | stok
		$data['kp337'] = [
		['nama medan','kodMedan','IO','Asal'],
		['Belanja','','',null],
		['Kos barang yang dijual','F090009','*',1534294],
		['Kos pembaikan, pemasangan dan penyelenggaraan','F098501','**',69333],
		['Nilai bekalan-Bahan dan bekas pembungkus','F090002','**',null],
		['Nilai bekalan-Bahan-bahan untuk pembaikan dan penyelenggaraan','F090003','**',1385],
		['Nilai bekalan-Alat tulis dan bekalan pejabat','F090005','**',null],
		['Nilai bekalan-Lain-lain','F090057','**',206294],
		['Kos percetakan','F090058','**',1626],
		['Air yang dibeli','F090006','**',780],
		['Tenaga elektrik yang dibeli','F090007','**',5561],
		['Bahan pembakar, pelincir dan gas','F090008','**',null],
		['Bayaran pembaikan dan penyelenggaraan semasa yang dibuat oleh pihak lain bagi harta tetap pertubuhan ini','F090011','',807],
		['Pengiklanan dan promosi','F090063','**',null],
		['Bayaran pemprosesan data dan lain-lain perkhidmatan yang berkaitan dengan teknologi maklumat','F090016','',null],
		['Bayaran telekomunikasi (cth. Telefon, internet dsb.)','F090017','**',5185],
		['Komisen dan bayaran agensi','F090109','',33520],
		['Pembelian perkhidmatan pengangkutan','F090119','**',3000],
		['Perbelanjaan perjalanan (termasuk perjalanan dalam dan luar negara, bil petrol/diesel dan bayaran letak kereta sendiri','F091002','',325],
		['Bayaran pos (termasuk perkhidmatan kurier)','F091007','',null],
		['Bayaran perakaunan, kesetiausahaan dan audit','F0910037','',180],
		['Bayaran guaman','F091004','',null],
		['Bayaran pengurusan','F091005','',null],
		['Perbelanjaan keraian','F091006','',990],
		['Bayaran bank','F091008','',292],
		['Premium insurans dibayar ke atas bangunan, jentera, alat pengangkutan dan barang','F091009','',121214],
		...
		['Perbelanjaan penyelidikan dan pembangunan','F090012','',null],
		...
		['Bayaran Sewa Lain-lain','F090023','**',null],
		['Susut nilai/perlunasan semasa ke atas harta tetap','F090024','',5159],
		['Bayaran Royalti kepada Kerajaan/Badan berkanun','F090026','**',null],
		['','F090026a','',null],
		['Bayaran Royalti kepada NGO/tajaan korporat','F090027','**',null],
		['','F090027a','',null],
		['Taksiran (ke atas tanah dan bangunan) dan cukai tanah','F090030','',null],
		['Cukai jalan','F090031','',null],
		['Bayaran pendaftaran perniagaan, lesen memandu dsb.','F090032','',2850],
		['Cukai perkhidmatan dan cukai jualan','F091010','',17732],
		...
		['Lain-lain perbelanjaan bukan operasi (sila nyatakan)','F091015','',null],
		['','F091015a','',null],
		...
		['Lain-lain perbelanjaan operasi (sila nyatakan butir-butir di bawah)','F090035','**',578],
		['','F090035a','',null],
		...
		['Bayaran berbentuk manfaat - Lain-lain spt makanan percuma, tempat tinggal percuma dsb.','F090039','',262],
		...
		['Nilai pakaian percuma yang disediakan','F090046','**',null],
		['Kos latihan kepada pekerja','F090047','**',null],
		['Kos pengangkutan pekerja(pergi dan balik dari tempat kerja)','F090048','',null],
		...
		['','F090051a','',null],
		['Bayaran kepada pertubuhan lain yang membekalkan pekerja','F090052','',null],
		['Bayaran bagi perkhidmatan keselamatan','F090067','',null],
		['Jumlah perbelanjaan (9.1 hingga 9.34)','F090089','',2207024],#74
		['Pindahan modal yang dibuat','F090053','',null],
		['Perbelanjaan pajakan kewangan','F090054','',null],
		['Dividen berbayar','F090055','',null],
		['Cukai langsung dibayar (cth. Cukai syarikat dan duti setem)','F090056','',null],
...
if ( ! function_exists('hasilKp337V01')):
	function hasilKp337V01()
	{
		...
		['Jualan alat ganti dan aksesori','F088503','*',null],
		['Jualan petrol dan gas','F088504','*',null],
		['Pendapatan dari bayaran perkhidmatan pembaikan pemasangan dan penyelenggaraan','F088505','*',null],
		['Komisen dan brokeraj dan yuran yang diterima','F080011','*',32718],
		['Pendapatan daripada perkhidmatan pengurusan','F080010','',130638],
		['Royalti, hakcipta, pelesenan dan yuran francais','F080014','*',null],
		['Pendapatan perkhidmatan yang diterima','F080022','',7448],
		...
		['Hasil Sewa Jentera dan kelengkapan','F080061','*',null],
		['Hasil Sewa Perabot dan pemasangan','F080062','*',null],
		['Hasil Sewa Lain-lain','F080013','*',null],
		['Subsidi gaji dan upah','F080064','',null],
		['Subsidi produk','F080065','',null],
		['Subsidi pengeluaran','F080066','',null],
		['Tuntutan dan pampasan yang diterima','F080067','',null],
		...
		['Kiriman wang, hadiah atau geran yang diterima','F080073','',3874],
		['Lain-lain pendapatan bukan operasi (sila nyatakan)','F080074','',null],
		['Lain-lain pendapatan operasi (sila nyatakan)','F080016','',null],
		...
		['Pindahan modal yang diterima','F080017','',null],
		['JUMLAH BESAR (8.11 hingga 8.12)','F080099','',2182380],#34
		];
		#
		return $data;//return array($tajuk,$data);
	}
